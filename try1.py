...
def show(pcu,mem,proc):
  show_boottime_info()
  show_cputime_info()
  show_cpupercent_info()
  show_cpucount_info()
  show_cpustats_info()
  show_cpufreq_info()
  show_virtualmemory_info()
  show_netiocounters_info()
  show_processes_info()
  

def main():
  boottime_info=get_boottime_info()
  cputime_info = get_cputime_info()
  cpupercent_info = get_cpupercent_info()
  cpucount_info = get_cpucount_info()
  cpustatus_info = get_cpustats_info()
